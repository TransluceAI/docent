...
The Docent Agent can flexibly support multi-step workflows that are time-consuming to implement manually or beneficial to conduct in parallel. For instance, the agent can support:
...
The Docent Agent saves scripts to your local directory. You can modify and rerun scripts for fine-grained control of the workflow.

<video controls width="100%">
  <source src="https://transluce-videos.s3.us-east-1.amazonaws.com/agentic-analysis-demo.mp4" type="video/mp4" />
...
<Tabs>
  <Tab title="Cursor Template">
    ...
    <AccordionGroup>
      <Accordion title="From the collections table" defaultOpen>
