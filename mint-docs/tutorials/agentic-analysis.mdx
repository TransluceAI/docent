...
<Tabs>
  <Tab title="Cursor Template">
    ...
    [Click here](https://drive.google.com/file/d/1qEW5oacYT44H9IGP6Qgq6eW12ls_qNZ9/view?usp=sharing) to download our template folder. Open it in a new Cursor workspace.
    ...
    The `.cursor/` directory is often hidden in your file explorer.
