...
# First, reflect on the query and think of examples of categories of items that should be included in the search results.
# Also think about examples of categories of items that other people might consider to be examples of the query, but that you do not think should be included.
# For instance, if the query is about types of meat, then chicken and seafood should be included, but tofu and artificial meats should not.

# Next, think carefully about whether the text contains any instances of the query.
