        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button size="sm" variant="ghost" className="text-primary px-2">
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4 text-sm">
                ...
                <p>
                  ...
                  anonymous. Only the Docent team sees your data. We will never
                  sell your data or track you outside of Docent. All session
                  recordings are deleted within 90 days. Change your preference
