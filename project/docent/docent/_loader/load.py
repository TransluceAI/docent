...
from docent._loader.load_custom import load_custom
from docent._loader.load_epoch import load_epoch_aime, load_epoch_swebench
from docent._loader.load_inspect import (
    load_agentharm,
    load_cybench,
    load_frontier_math,
    load_k8s,
...
from docent._loader.load_oh_swe_bench import load_oh_swe_bench
from docent._loader.load_tau_bench import load_tau_bench
...
# Use ENV_TYPE to determine which EVALS_SPECS_DICT to use
EVALS_SPECS = EVALS_SPECS_DICT[os.getenv("ENV_TYPE") or "prod"]
